...
int main(int argc, char *argv[]) {
    ...
    cfg_opt_t battery_opts[] = {
        ...
        CFG_STR("format_empty", "%status", CFGF_NONE),
        ...
        CFG_STR("status_empty", "DEAD", CFGF_NONE),
        CFG_BOOL("override_idle", false, CFGF_NONE),
        ...
        for (j = 0; j < cfg_size(cfg, "order"); j++) {
            ...
            CASE_SEC_TITLE("battery") {
                ...
                battery_info_ctx_t ctx = {
                    ...
                    .format_down = cfg_getstr(sec, "format_down"),
                    .format_empty = cfg_getstr(sec, "format_empty"),
                    ...
                    .status_empty = cfg_getstr(sec, "status_empty"),
                    .override_idle = cfg_getbool(sec, "override_idle"),
